...
test("Instruction: POPENV", () => {
    ...
    const prevState = State.new()
        .setStack(Stack.of(new UninitializedCell(), new UninitializedCell(), new UninitializedCell(),
            ...
            new UninitializedCell(), new UninitializedCell(), new PointerToStackCell(3), new ValueCell(42),
            new UninitializedCell())).setFramePointer(10).setProgramCounter(12);

    const expectedState = State.new()
        .setStack(Stack.of(new UninitializedCell(), new UninitializedCell(), new UninitializedCell(),
            new UninitializedCell(), new UninitializedCell())).setFramePointer(3).setProgramCounter(42);
